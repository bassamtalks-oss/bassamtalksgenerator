...
export const movieLooks: { id: MovieLook; name: string }[] = [
  ...
  { id: 'digital_nightscape', name: 'Digital Nightscape' },
  { id: 'documentary_natural', name: 'Documentary Natural' },
  { id: 'dreamlike_memories', name: 'Dreamlike Memories' },
  { id: 'futuristic_neon_blue', name: 'Futuristic Neon Blue' },
  { id: 'golden_ancient_rome', name: 'Golden Ancient Rome' },
  { id: 'green_tinted_digital', name: 'Green-Tinted Digital' },
  { id: 'movie_high_contrast_bw', name: 'High Contrast B&W' },
  { id: 'muted_elegance', name: 'Muted Elegance' },
  { id: 'near_future_warmth', name: 'Near Future Warmth' },
  { id: 'neon_cyberpunk', name: 'Neon Cyberpunk' },
  { id: 'overexposed_folk', name: 'Overexposed Folk' },
  { id: 'pastel_symmetrical', name: 'Pastel Symmetrical' },
  { id: 'saturated_apocalyptic', name: 'Saturated Apocalyptic' },
  { id: 'saturated_pop_culture', name: 'Saturated Pop Culture' },
  { id: 'soft_countryside', name: 'Soft Countryside' },
  { id: 'soft_warmth', name: 'Soft Warmth' },
  { id: 'sun_drenched_summer', name: 'Sun-Drenched Summer' },
  { id: 'symmetrical_precision', name: 'Symmetrical Precision' },
  { id: 'warm_whimsy', name: 'Warm Whimsy' },
  { id: 'warm_wonder', name: 'Warm Wonder' },
];
